...
func Test_openapi_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService UpdateCluster", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.UpdateCluster(context.Background(), clusterUuid).Execute()
	...
	t.Run("Test DefaultAPIService UpdateIpAllowlist", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var clusterUuid string

		httpRes, err := apiClient.DefaultAPI.UpdateIpAllowlist(context.Background(), clusterUuid).Execute()
	...
	t.Run("Test DefaultAPIService Wake", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var clusterUuid string

		httpRes, err := apiClient.DefaultAPI.Wake(context.Background(), clusterUuid).Execute()
